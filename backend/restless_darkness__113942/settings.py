"""
Django settings for restless_darkness__113942 project.
...
ROOT_URLCONF = 'restless_darkness__113942.urls'
...
WSGI_APPLICATION = 'restless_darkness__113942.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_darkness__113942 API",
    "DESCRIPTION": "API documentation for restless_darkness__113942 App",
    "VERSION": "v1",
}
